...
const RecommendationCard = (props) => {
  ...
  return (
    <div onClick={()=>data.setSuggestionValue(props.content)} className='bg-gray-900 rounded-lg flex items-center justify-center h-10 cursor-pointer hover:bg-slate-700'>
